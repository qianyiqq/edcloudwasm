...
static TEMPLATES: [&[u8]; 12] = [
    ...
    b"vless://{{UUID}}@{{IP}}:443?sni={{HOST}}&host={{HOST}}&path={{PATH}}&encryption=none&security=tls&fp=chrome&allowInsecure=0&type=ws&ech=cloudflare-ech.com%2Bhttps%3A%2F%2F223.5.5.5%2Fdns-query&alpn=http%2F1.1&insecure=0#[ECH]-ws-vless-{{IP}}",
    ...
    b"trojan://{{PASSWORD}}@{{IP}}:443?sni={{HOST}}&host={{HOST}}&path={{PATH}}&security=tls&fp=chrome&allowInsecure=0&type=ws&ech=cloudflare-ech.com%2Bhttps%3A%2F%2F223.5.5.5%2Fdns-query&alpn=http%2F1.1&insecure=0#[ECH]-ws-trojan-{{IP}}",
